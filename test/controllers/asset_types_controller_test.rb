...
class AssetTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asset_type" do
    assert_difference('AssetType.count') do
      post asset_types_url, params: { asset_type: { abbreviation: @asset_type.abbreviation, name: @asset_type.name } }
    end
  ...
  test "should update asset_type" do
    patch asset_type_url(@asset_type), params: { asset_type: { abbreviation: @asset_type.abbreviation, name: @asset_type.name } }
