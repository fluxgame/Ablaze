class HomeController < ApplicationController
  def reports
    ...
    current_user.report_data.each do |rd|
      lean_fi_date = current_user.fi_date(rd.date, current_user.aggregate_amounts(rd.date)[:lean_fi_expenses], rd.net_worth, rd.annual_savings, rd.average_rate_of_return)
